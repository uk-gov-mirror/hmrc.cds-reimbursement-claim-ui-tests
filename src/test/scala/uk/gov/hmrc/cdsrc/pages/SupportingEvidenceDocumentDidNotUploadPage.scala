...
object SupportingEvidenceDocumentDidNotUploadPage extends BasePage {
  ...
  override def expectedPageTitle: Option[String] = Some("There is a problem with the file you uploaded")
